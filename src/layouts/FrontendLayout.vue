<template>
  <div>
    <Loader />
      <NavHeader :items="headerItem" :userprofile="profile" :homeURL="{ name: 'landing-page.landing-page' }"  logo="https://cdn.shopify.com/s/files/1/0269/8225/2611/files/sector_x_logo_colour_f42bacbf-fa87-42fc-825c-4c0a469e292c_1080x.png?v=1587643357" >
          ...
          <ul class="d-flex align-items-center justify-content-end list-inline m-0">
                  ...
                  <div class="iq-card-body  ">
                    <a href="#" class="iq-sub-card">
                        <div class="media align-items-center">
                          <img src="../assets/images/frontend/notify/thumb-1.jpg" class="img-fluid mr-3"
                              alt="streamit" />
                    ...
                    <a href="#" class="iq-sub-card">
                        <div class="media align-items-center">
                          <img src="../assets/images/frontend/notify/thumb-2.jpg" class="img-fluid mr-3"
                              alt="streamit" />
                          <div class="media-body">
                    ...
                    <a href="#" class="iq-sub-card">
                        <div class="media align-items-center">
                          <img src="../assets/images/frontend/notify/thumb-3.jpg" class="img-fluid mr-3"
                              alt="streamit" />
                          <div class="media-body">
            ...
            <li class="nav-item nav-icon" v-nav-toggle>
              <a href="#" class="iq-user-dropdown search-toggle p-0 d-flex align-items-center">
                <img :src="userProfile" class="img-fluid avatar-40 rounded-circle" alt="user">
              </a>
              <div class="iq-sub-dropdown iq-user-dropdown">
                <div class="iq-card shadow-none m-0">
                  <div class="iq-card-body p-0 pl-3 pr-3">
                      <a :href="$router.resolve({name: 'dashboard.home-1'}).href" class="iq-sub-card setting-dropdown">
                        <div class="media align-items-center">
